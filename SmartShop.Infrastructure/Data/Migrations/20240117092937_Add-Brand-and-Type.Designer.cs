...
namespace SmartShop.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240117092937_Add-Brand-and-Type")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartShop.Core.ProductBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartShop.Core.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartShop.Product", b =>
                {
                    b.HasOne("SmartShop.Core.ProductBrand", "ProductBrand")
                        .WithMany()
                        .HasForeignKey("ProductBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartShop.Core.ProductType", "ProductType")
                        .WithMany()
